...
function() {
    ...
    function(e, t, i) {
        ...
        var y = function(e) {
            function t(e) {
                ...
                (0, p.extend)(i.options, e),
                i.data = i.options.data,
                i.pickerEl = (0, f.createDom)((0, m["default"])({
                    data: i.data,
        ...
        function() {
                ...
                t.BScroll = function(e) {
                            ...
                            function() {
                                if (e.pages = [], e.wrapperWidth && e.wrapperHeight && e.scrollerWidth && e.scrollerHeight) {
                                    ...
                                    if (e.options.snap === !0) for (o = Math.round(t / 2), s = Math.round(i / 2); n > -e.scrollerWidth;) {
                                        ...
                                        n -= t,
                                        l++
                                    } else for (p = e.options.snap, c = p.length, u = -1; c > l; l++) f = (0, a.getRect)(p[l]),
                                    (0 === l || f.left <= (0, a.getRect)(p[l - 1]).left) && (h = 0, u++),
                                    e.pages[h] || (e.pages[h] = []),
                    ...
                    },
                    {
                        ...
                        value: function(e, t) {
                            ...
                            return i === this.currentPage.pageX && (i += this.directionX, 0 > i ? i = 0 : i >= this.pages.length && (i = this.pages.length - 1), e = this.pages[i][0].x),
                            r === this.currentPage.pageY && (r += this.directionY, 0 > r ? r = 0 : r >= this.pages[0].length && (r = this.pages[0].length - 1), t = this.pages[0][r].y),
                            {
                                x: e,
                                y: t,
                                pageX: i,
                        ...
                        value: function(e) {
                            if (this.enabled && a.eventType[e.type] === this.initiated) {
                                ...
                                if (! (s - this.endTime > this.options.momentumLimitTime && o < this.options.momentumLimitDistance && r < this.options.momentumLimitDistance)) {
                                    ...
                                    var l = this.x + i,
                                    c = this.y + n; (l > 0 || l < this.maxScrollX) && (l = this.x + i / 3),
                                    (c > 0 || c < this.maxScrollY) && (c = this.y + n / 3),
                                    this.directionX = i > 0 ? -1 : 0 > i ? 1 : 0,
                                    this.directionY = n > 0 ? -1 : 0 > n ? 1 : 0,
                        ...
                        value: function(e) {
                            if (this.enabled && a.eventType[e.type] === this.initiated && (this.initiated = !1, this.options.preventDefault && !(0, a.preventDefaultException)(e.target, this.options.preventDefaultException) && e.preventDefault(), !this.resetPosition(this.options.bounceTime, a.ease.bounce))) {
                                ...
                                if (this.options.momentum && o < this.options.momentumLimitTime && (l > this.options.momentumLimitDistance || s > this.options.momentumLimitDistance)) {
                                    ...
                                    t = h.destination,
                                    i = u.destination,
                                    c = Math.max(h.duration, u.duration),
                                    this.isInTransition = 1
                                ...
                                if (this.options.snap) {
                                    ...
                                    this.currentPage = f,
                                    c = this.options.snapSpeed || Math.max(Math.max(Math.min(Math.abs(t - f.x), 1e3), Math.min(Math.abs(i - f.y), 1e3)), 300),
                                    t = f.x,
                                    i = f.y,
                                    this.directionX = 0,
                                    this.directionY = 0,
                                ...
                                if (t !== this.x || i !== this.y) return (t > 0 || t < this.maxScrollX || i > 0 || i < this.maxScrollY) && (p = a.ease.swipeBounce),
                                void this.scrollTo(t, i, c, p);
                    ...
                    },
                    {
                        ...
                        value: function() {
                            ...
                            if (this.scrollerStyle[a.style.transitionDuration] = t + "ms", this.options.wheel && !a.isBadAndroid) for (var i = 0; i < this.itemLen; i++) this.items[i].style[a.style.transitionDuration] = t + "ms"; ! t && a.isBadAndroid && (this.scrollerStyle[a.style.transitionDuration] = "0.001s", (0, a.requestAnimationFrame)(function() {
                    ...
                    },
                    {
                        ...
                        value: function() {
                            ...
                            this.options.wheel ? (this.items = this.scroller.children, this.options.itemHeight = this.itemHeight = this.items.length ? this.items[0].clientHeight: 0, void 0 === this.selectedIndex && (this.selectedIndex = this.options.selectedIndex), this.options.startY = -this.selectedIndex * this.itemHeight, this.itemLen = this.items.length, this.maxScrollX = 0, this.maxScrollY = -this.itemHeight * (this.itemLen - 1)) : (this.maxScrollX = this.wrapperWidth - this.scrollerWidth, this.maxScrollY = this.wrapperHeight - this.scrollerHeight),
                    ...
                    },
                    {
                        ...
                        value: function(e, t, i) {
                            ...
                            i && !this.options.useTransition || (this._transitionTimingFunction(n.style), this._transitionTime(i), this._translate(e, t), i && 3 === this.options.probeType && this._startProbe(), this.options.wheel && (t > 0 ? this.selectedIndex = 0 : t < this.maxScrollY ? this.selectedIndex = this.itemLen - 1 : this.selectedIndex = 0 | Math.abs(t / this.itemHeight)))
                        }
                    },
                    {
            ...
            function(e, t) {
                ...
                function i(e, t, i, n, r, o) {
                    ...
                    n > d ? (d = r ? n - r / f * a: n, p = h - u) : d > 0 && (d = r ? r / f * a: 0, p = h - u),
                    {
    ...
    function(e, t) {
        ...
        function i(e, t) {
            ...
            r && (this.lineNumber = o, this.column = s)
        }
        t.__esModule = !0;
    ...
    function(e, t, i) {
        ...
        t["default"] = function(e) {
            ...
            function(e, t) {
                function i(t, i, o) {
                    c && (c.key = t, c.index = i, c.first = 0 === i, c.last = !!o, h && (c.contextPath = h + t)),
                    l += n(e[t], {
                        data: c,
    ...
    function(e, t, i) {
        ...
        t["default"] = function(e) {
            ...
            function(e, t) {
                ...
                var r = t.data;
                return t.data && t.ids && (r = n.createFrame(t.data), r.contextPath = n.appendContextPath(t.data.contextPath, t.ids[0])),
                i(e, {
                    data: r,
        ...
        r = {
            ...
            log: function(e) {
                if (e = r.lookupLevel(e), "undefined" != typeof console && r.lookupLevel(r.level) <= e) {
                    ...
                    n = Array(i > 1 ? i - 1 : 0), o = 1; i > o; o++) n[o - 1] = arguments[o];
    ...
    function(e, t, i) {
        ...
        function s(e, t) {
            ...
            var r = {
                ...
                lookup: function(e, t) {
                    for (var i = e.length,
                    n = 0; i > n; n++) if (e[n] && null != e[n][t]) return e[n][t]
                },
                lambda: function(e, t) {
                ...
                program: function(e, t, i, n, r) {
                    ...
                    s = this.fn(e);
                    return t || r || n || i ? o = a(this, e, s, t, i, n, r) : o || (o = this.programs[e] = a(this, e, s)),
                    o
                },
                data: function(e, t) {
                    for (; e && t--;) e = e._parent;
        ...
        function a(e, t, i, n, r, o, s) {
            function a(t) {
                ...
                i(e, t, e.helpers, e.partials, r.data || n, o && [r.blockParams].concat(o), a)
            }
            return a = p(i, a, e, s, n, o),
            a.program = t,
        ...
        function c(e, t, i) {
            ...
            var n = void 0;
            if (i.fn && i.fn !== h && (i.data = g.createFrame(i.data), n = i.data["partial-block"] = i.fn, n.partials && (i.partials = d.extend({},
            i.partials, n.partials))), void 0 === e && n && (e = n), void 0 === e) throw new v["default"]("The partial " + i.name + " could not be found");
        ...
        function p(e, t, i, n, r, o) {
            if (e.decorator) {
                var s = {};
                t = e.decorator(t, s, i, n && n[0], r, o, n),
                d.extend(t, s)
            }
            return t
        }
    ...
    function(e, t, i) {
        ...
        e.exports = (n["default"] || n).template({
            ...
            main: function(e, t, i, n, r) {
                var o;
                return null != (o = i.each.call(null != t ? t: {},
                t, {
                    name: "each",
                    hash: {},
                    fn: e.program(1, r, 0),
